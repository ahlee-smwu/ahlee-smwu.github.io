...
<div class="duo">
  <div class="panel">
    ...
    <ul>
      <li>GMM clustering of VAE latents → structural modes already in the dataset.</li>
  ...
  <div class="panel">
    ...
    <ul>
      ...
      <li>SNR-aware blend ω(t) controls the decay.</li>
...
<ul class="stats">
  <li class="stat"><span class="stat__num">5.40</span><span class="stat__label">FID @ 40 NFE<br>ImageNet-1K, 50 epochs</span></li>
  <li class="stat"><span class="stat__num">84%</span><span class="stat__label">fewer NFEs<br>than baseline</span></li>
...
<figure class="fig">
  ...
  <figcaption>FID (left) and Precision (right) vs. NFE. RAPID stays strong in the few-step region (shaded).</figcaption>
</figure>
...
<div class="fig-grid">
  ...
  <figure class="fig">
    ...
    <figcaption>LSUN-Church Outdoor samples.</figcaption>
  </figure>
</div>
...
<ul class="keys">
  ...
  <li><span class="badge badge--award">Best Paper</span> <em>Adaptive Prior Diffusion: Dataset-Aware GMM Prior for High-Fidelity Image Generation</em> — KMMS Spring 2026 (first author).</li>
  <li><span class="badge badge--award">Best Paper</span> <em>An Optimized Diffusion Model Based on Adaptive Prior Distribution</em> — KMMS Autumn 2025 (first author).</li>
